...
async function start() {
  ...
  clientConfig.entry[entryFile] = [
    'webpack-hot-middleware/client?name=client&reload=true',
  ].concat(clientConfig.entry[entryFile]).sort((a, b) => b.includes('polyfill') - a.includes('polyfill'));
  ...
  let appPromise; //  eslint-disable-line
  ...
  await new Promise((resolve, reject) => browserSync.create().init({
    ...
    files: ['build/public/css/**/*', 'build/views/**/*'],  // ['public/js/*js', 'public/css/**/*.css'],
    proxy: {
