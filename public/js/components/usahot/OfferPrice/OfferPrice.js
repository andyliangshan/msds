        ...
        <div className="rel1100">
          <div className="offer-school">
              ...
              {offerData.usa.map((item, index) => {
                return (
                  <div className="offerlist-school-box" key={Math.random()} onMouseEnter={(e) => this.handMouseOver(e, index)} onMouseLeave={(e) => this.handMouseOut(e, index)}>
                    <div className="offerlist-school-box-img"><img src={`/public/img/usaAllPic/offer/offer0${(index + 1)}.jpg`} alt="" /></div>
                    <div className="offerlist-school-box-desc" ref={`desc${index}`}>
                      ...
                      <div className="offerlist-desc-offerbig" data-toggle="modal" data-target="#offer-image"
                           onClick={evt => this.showOfferImg(evt, `/public/img/usaAllPic/offer/offer0${(index + 1)}.jpg`)}>{item.offerClickImg}</div>
                    </div>
                  </div>
                );
              })}
            ...
            <div className="visitor-desc-btn">
              <a className="btn graybtn" href="http://zt.shunshunliuxue.com/usa/master/2017offer/" target="_blank">查看2017年最新录取</a>
